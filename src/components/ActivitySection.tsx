      ...
      <section className="space-y-8">
        <div className="max-w-2xl space-y-2">
          ...
          <p className="text-xs text-[#4f5d75]">
            단순히 복지관 사무실에 머무는 것이 아니라, 인천 제물포구 원도심 골목 구비구비에 숨어 있는 진짜 상점과 전문가들의 공간으로 찾아갑니다.
          </p>
        </div>
      ...
      <section className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="max-w-xl space-y-2">
            ...
            <p className="text-xs text-[#4f5d75]">
              재미난회사를 거쳐 간 참여자분들께서 남겨 주신 실제 활동 일지와 소감입니다. 그들의 문장 속에서 용기를 찾아 보셔요.
            </p>
          </div>
            ...
            {filteredDiaries.length > 0 ? (
              ...
              >
                ...
                <p className="text-xs text-[#5c677d] max-w-md mx-auto leading-relaxed">
                  재미난회사 참여자분들이 3대 지역거점(느호카페, 나무디자인, 재미난가죽)에서 만들어갈 소박하고 이쁜 첫 일상 기록이 차곡차곡 여기에 담겨집니다. 따스하게 기대해 주세요!
                </p>
              </motion.div>
            )}
          </AnimatePresence>
